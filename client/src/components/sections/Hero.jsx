      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <motion.p
            ...
            className="max-w-xl text-base leading-relaxed text-slate-300/75 sm:text-lg"
          >
        ...
        <div className="relative grid h-[480px] grid-cols-2 grid-rows-2 gap-3 sm:h-[560px] lg:h-[640px]">
          ...
          >
            ...
            <motion.div
              className="absolute right-3 top-3 rounded-2xl border border-white/15 bg-slate-950/70 px-3 py-2 text-center backdrop-blur-md"
